...
INSERT OR IGNORE INTO projects (id, display_name) VALUES ('global', 'Global Memory');
...
INSERT OR IGNORE INTO users (id, display_name) VALUES ('global', 'Global User');
...
CREATE INDEX IF NOT EXISTS idx_sessions_project_user ON sessions(project_id, user_id, updated_at);
...
CREATE INDEX IF NOT EXISTS idx_entities_project_user ON entities(project_id, user_id, entity_type);
...
CREATE INDEX IF NOT EXISTS idx_preferences_project ON preferences(project_id, category);
CREATE INDEX IF NOT EXISTS idx_preferences_project_user ON preferences(project_id, user_id, category);
...
CREATE INDEX IF NOT EXISTS idx_facts_project ON facts(project_id, subject);
CREATE INDEX IF NOT EXISTS idx_facts_predicate ON facts(predicate);
CREATE INDEX IF NOT EXISTS idx_facts_project_user ON facts(project_id, user_id, subject);
...
CREATE INDEX IF NOT EXISTS idx_traces_project ON reasoning_traces(project_id, started_at);
CREATE INDEX IF NOT EXISTS idx_traces_session ON reasoning_traces(session_id);
CREATE INDEX IF NOT EXISTS idx_traces_project_user ON reasoning_traces(project_id, user_id, started_at);
...
CREATE INDEX IF NOT EXISTS idx_steps_trace ON reasoning_steps(trace_id, step_number);
...
/**
 * Apply the migration SQL to the D1 database.
